...
public class ChBackLightGalva {
    ...
    public static ChBackLightGalva create(BackLightVo vo){

        return ChBackLightGalva.builder()
    ...
    public void updateBackLightGalva(BackLightVo vo){
        this.led = vo.getLed();
