...
@Setter
@Entity
public class ChFrontBackLightStan {
    ...
    public static ChFrontBackLightStan create(FrontBackLightVo vo){

        return ChFrontBackLightStan.builder()
    ...
    public void updateFrontBackLightStan(FrontBackLightVo vo){
        this.led = vo.getLed();
